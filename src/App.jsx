  ...
  const totalCost = cart.reduce((total, item) => total + item.price, 0);
     ...
     return (
      ...
      <ToastContainer autoClose={2000} />
          ...
          {/* --- FOOTER SECTION --- */}
          <footer id="footer" className="bg-[#0B1120] text-white py-16 px-6 md:px-20 border-t border-gray-800">
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                
                {/* Brand Column */}
                <div className="md:col-span-4">
                  <h3 className="text-3xl font-bold mb-6">DigiTools</h3>
                ...
                <div className="md:col-span-2">
                  <h5 className="font-bold text-white mb-6 text-[16px]">Product</h5>
                ...
                <div className="md:col-span-2">
                  <h5 className="font-bold text-white mb-6 text-[16px]">Company</h5>
                  <ul className="space-y-4 text-slate-400 text-[14px]">
                ...
                <div className="md:col-span-2">
                  <h5 className="font-bold text-white mb-6 text-[16px]">Resources</h5>
                  <ul className="space-y-4 text-slate-400 text-[14px]">
                ...
                {/* Social Links */}
                <div className="md:col-span-2">
                  <h5 className="font-bold text-white mb-6 text-[16px]">Social Links</h5>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#0B1120] cursor-pointer hover:bg-slate-200 transition-colors">
